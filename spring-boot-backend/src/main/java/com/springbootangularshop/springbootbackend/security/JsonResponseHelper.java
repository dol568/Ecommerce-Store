...
import com.springbootangularshop.springbootbackend.system.ErrorResponse;
...
public class JsonResponseHelper {
    public static void writeJsonResponse(HttpServletResponse response, ErrorResponse errorResponse, HttpStatus httpStatus)
            throws IOException {
